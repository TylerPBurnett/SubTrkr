# ItemForm Original Styling

This is the original `ItemForm.tsx` before the design refresh. To revert, replace the contents of `/src/components/ItemForm.tsx` with the code below.
