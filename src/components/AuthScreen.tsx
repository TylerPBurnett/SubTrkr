...
export default function AuthScreen() {
  ...
  const getPasswordStrength = (
    ...
    if (score <= 2)
      return { score, label: 'Weak', barColor: 'var(--accent-red)', textColor: 'var(--accent-red)' };
    if (score <= 4)
      return { score, label: 'Medium', barColor: 'var(--accent-amber)', textColor: 'var(--accent-amber)' };
